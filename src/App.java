public class App {
    public static void main(String[] args) {
        ...
        //Creates string color from console input and checks whether it is a HEX code (starts with "0x" or a hashtag)
        //or an RGB code (starts with "(" or contains a space or a comma).
        //Subsequently writes the latter into several booleans.

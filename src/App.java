//Color Code Converter v0.0.3_5-nonfull.
...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println("Color Code Converter v0.0.3_5-nonfull.");
        ...
        //Creates strings for colours and an unchanging condition so that the following while loop
        //is infinite.
        String whileLoop = "do";
        String ANSI_RED = "\u001B[31m";
